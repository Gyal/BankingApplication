...
public class TransactionEntityTest {
    private static final Logger LOGGER = LoggerFactory.getLogger(TransactionEntity.class);
    @Autowired
    ...
    @Test
    public void construteurEntityAccount() {
        ...
        TransactionEntity test = new TransactionEntity(id, transactionType, amount, transactionDate, account);


        assertThat(test, notNullValue());
        assertThat(test.getIdTransaction(), is(id));
        assertThat(test.getAmount(), is(amount));
        assertThat(test.getAccount(), is(account));
        assertThat(test.getTransactionDate(), is(transactionDate));
        assertThat(test.getTransactionType(), is(transactionType));
    }

    @Test
    public void construteurEntityOperation() {
        ...
        TransactionEntity test = new TransactionEntity(id, transactionType, amount, transactionDate, operationDetail);


        assertThat(test, notNullValue());
        assertThat(test.getIdTransaction(), is(id));
        assertThat(test.getAmount(), is(amount));
        assertThat(test.getOperationDetail(), is(operationDetail));
        assertThat(test.getTransactionDate(), is(transactionDate));
        assertThat(test.getTransactionType(), is(transactionType));
    }
